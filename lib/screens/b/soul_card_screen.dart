...
import 'package:daily_tarot_poc_app_4/screens/b/my_soul_card_screen1.dart';
            ...
            child: button1("달 10개로 소울카드 찾기", () {
              if (date == null || appController.moon < 10) {
                appController.showSnack(
                  context,
                  date == null ? "생일을 입력해 주십시오" : "달 개수가 부족합니다.",
                );
                return;
              }
              ...
              appController.move(
                context,
                MySoulCardScreen1(card: appController.getSoulCard()),
              );
            }, isMoon: true),
          ),
          SizedBox(height: 18),
  ...
  Widget datePicker() {
    ...
    return Dialog(
      child: Container(
        ...
        padding: .symmetric(horizontal: 28, vertical: 12),
        child: Column(
          spacing: 6,
